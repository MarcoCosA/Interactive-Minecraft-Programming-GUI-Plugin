...
public class RandomWeightedProjectile extends EventSegment {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		ArrayList<Class<EventSegment>> classes = GachaItems
				.getProjectileSegmentsOfRarity(GachaItems.randomRarityInt(proc.getSeed(), 5));
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(ChatColor.RED + "Weighted Random Projectile");
