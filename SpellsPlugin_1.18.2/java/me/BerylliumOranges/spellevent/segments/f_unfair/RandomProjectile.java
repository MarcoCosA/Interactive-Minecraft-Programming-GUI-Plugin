...
public class RandomProjectile extends EventSegment {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		Class<EventSegment> clazz = EventTriggerSegment.ALL_PROJECTILE_SEGMENTS.get(
				(int) (new Random(proc.getSeed()).nextDouble() * EventTriggerSegment.ALL_PROJECTILE_SEGMENTS.size()));
		try {
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(ChatColor.RED + "Random Projectile");
		meta.setLore(Arrays.asList(ChatColor.WHITE + "Casts a random " + ChatColor.YELLOW + "projectile"));
