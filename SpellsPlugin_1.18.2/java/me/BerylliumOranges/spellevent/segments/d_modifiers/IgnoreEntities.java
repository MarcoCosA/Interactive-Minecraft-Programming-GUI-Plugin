...
public class IgnoreEntities extends EventSpellModifier {

	public final static ItemStack ITEM = getUpdatedItem(new int[2], 0);
	public final static String LOCAL_NAME = ITEM.getItemMeta().getLocalizedName();
	public static final double MANA_COST = 1;
	public static final double COST_PER_BLOCK = SpellProjectile.BASE_COST / 4.0;
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		proc.getProjectileModifiers().add(new IgnoreEntities(proc));
	...
	public boolean applyProjectileModifier(SpellProjectile proj, boolean finalCall) {
		...
		proj.setInteractWithEntities(false);
		return true;
	}
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Ignore Entities");
		ArrayList<String> lore = new ArrayList<String>(Arrays.asList(ChatColor.WHITE + "Your next projectile does not ",
				ChatColor.AQUA + "interact" + ChatColor.WHITE + " with entities", "", getCostPerBlock(COST_PER_BLOCK),
	...
	public IgnoreEntities(SegmentProcess proc) {
		super(proc);
	}
}
