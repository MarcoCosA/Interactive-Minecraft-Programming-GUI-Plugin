...
public class ShortenProjectile extends EventSpellModifier {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		for (int i = 0; i < proc.getPresentSegments()[proc.getY()][proc.getX()].getAmount(); i++)
			proc.getProjectileModifiers().add(new ShortenProjectile(proc));
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Shorten Projectile");
		ArrayList<String> lore = new ArrayList<String>(
				Arrays.asList(ChatColor.WHITE + "Your next projectile is half as long", ChatColor.DARK_GRAY + "Stacks",
	...
	public ShortenProjectile(SegmentProcess proc) {
		super(proc);
	}
}
