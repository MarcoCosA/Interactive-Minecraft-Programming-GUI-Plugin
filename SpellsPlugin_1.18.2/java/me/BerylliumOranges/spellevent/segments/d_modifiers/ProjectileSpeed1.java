...
public class ProjectileSpeed1 extends EventSpellModifier {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		proc.getProjectileModifiers().add(new ProjectileSpeed1(proc));
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Projectile Speed I");
	...
	public ProjectileSpeed1(SegmentProcess proc) {
		super(proc);
	}
}
