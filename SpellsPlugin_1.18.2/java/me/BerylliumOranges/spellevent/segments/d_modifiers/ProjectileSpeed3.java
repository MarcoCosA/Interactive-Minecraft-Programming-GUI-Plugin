...
public class ProjectileSpeed3 extends EventSpellModifier {

	public final static ItemStack ITEM = getUpdatedItem(new int[2], 0);
	public final static String LOCAL_NAME = ITEM.getItemMeta().getLocalizedName();
	public static final double VELOCITY_MODIFIER = 8;
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		proc.getProjectileModifiers().add(new ProjectileSpeed3(proc));
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Projectile Speed III");
	...
	public ProjectileSpeed3(SegmentProcess proc) {
		super(proc);
	}
}
