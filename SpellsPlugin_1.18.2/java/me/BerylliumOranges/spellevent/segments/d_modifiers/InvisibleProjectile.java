...
public class InvisibleProjectile extends EventSpellModifier {
	...
	public static final ArrayList<Material> BLOCK_TYPES = new ArrayList<Material>(Arrays.asList(Material.COBBLESTONE,
			Material.FIRE, Material.LAVA, Material.ANVIL, Material.POINTED_DRIPSTONE));
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		proc.getProjectileModifiers().add(new InvisibleProjectile(proc));
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Invisible Projectile");
	...
	public InvisibleProjectile(SegmentProcess proc) {
		super(proc);
	}

	public static int getSize(int upgrades[]) {

		return (int) (SIZE + (upgrades[0] + upgrades[1]) / 4.0F);
	}
