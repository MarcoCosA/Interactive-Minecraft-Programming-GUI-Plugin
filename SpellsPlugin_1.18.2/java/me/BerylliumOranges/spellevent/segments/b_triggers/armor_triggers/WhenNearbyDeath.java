...
public final class WhenNearbyDeath extends EventTriggerSegment {
	public final static ItemStack ITEM = getUpdatedItem(new int[2], 0);
	public final static String LOCAL_NAME = ITEM.getItemMeta().getLocalizedName();
	public static final double MANA_COST = 30;

	public static final int MIN_HP = 20;
	public static final int RARITY = 4;

	public static final List<String> ACCEPTED_TAGS = Arrays.asList(EventSegment.NEARBY_DEATH_TRIGGER_TAG);

	public static Guideline processSegment(SegmentProcess proc) {

		if (!hasTag(proc, WhenNearbyDeath.class) || proc.addSegmentCooldown(WhenNearbyDeath.class, (int) MANA_COST)) {
...
//				false);
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "When An Entity Nearby Dies");
		ArrayList<String> lore = new ArrayList<String>(Arrays.asList(
				ChatColor.WHITE + "Casts the spell on entities with",
				ChatColor.WHITE + "more than " + ChatColor.RED + MIN_HP + " " + ChatColor.WHITE + "HP that "
						+ ChatColor.RED + "die " + ChatColor.WHITE + "nearby",
