...
public final class WhenNearbyEat extends EventTriggerSegment {
	...
	public static final List<String> ACCEPTED_TAGS = Arrays.asList(EventSegment.NEARBY_EAT_TRIGGER_TAG);

	public static Guideline processSegment(SegmentProcess proc) {

		if (!hasTag(proc, WhenNearbyEat.class) || proc.addSegmentCooldown(WhenNearbyEat.class, (int) MANA_COST)) {
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "When A Nearby Player Eats Food");
		ArrayList<String> lore = new ArrayList<String>(
				Arrays.asList(ChatColor.WHITE + "Casts the spell on players who eat",
						ChatColor.WHITE + "food within " + ChatColor.YELLOW + DISTANCE + " " + ChatColor.WHITE
								+ "blocks of the caster",
