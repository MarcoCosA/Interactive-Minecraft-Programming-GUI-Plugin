...
public final class Web extends EventTriggerSegment {
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Spell Web");
		ArrayList<String> lore = new ArrayList<String>(Arrays.asList(
				ChatColor.WHITE + "Launches " + ChatColor.YELLOW + PROJECTILE_COUNT + ChatColor.GOLD
						+ " Short Projectiles ",
				ChatColor.WHITE + "that " + ChatColor.GOLD + "bounce " + ChatColor.WHITE + "off of blocks", "",
