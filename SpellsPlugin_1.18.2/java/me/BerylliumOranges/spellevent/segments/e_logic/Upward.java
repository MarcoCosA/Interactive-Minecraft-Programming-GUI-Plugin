...
public class Upward extends EventSegment {
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Upward Segment");
		meta.setLore(Arrays.asList(ChatColor.WHITE + "Points your spell upwards " + ChatColor.GRAY
				+ SpellActions.getArrowModelFromInt(dir), "", getCostText(MANA_COST)));
