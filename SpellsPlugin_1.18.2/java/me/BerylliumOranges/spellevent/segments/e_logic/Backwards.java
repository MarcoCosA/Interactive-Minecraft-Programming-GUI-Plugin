...
public class Backwards extends EventSegment {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		proc.getSpellLocation().setDirection(proc.getSpellLocation().getDirection().clone().multiply(-1));
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Backwards Segment");
		meta.setLore(Arrays.asList(ChatColor.WHITE + "Points your spell backwards", "",
