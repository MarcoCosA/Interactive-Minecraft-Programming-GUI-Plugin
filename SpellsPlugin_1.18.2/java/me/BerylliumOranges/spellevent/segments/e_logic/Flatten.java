...
public class Flatten extends EventSegment {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		proc.getSpellLocation().setDirection(new Vector(proc.getSpellLocation().getDirection().getX(), 0,
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Flatten");
		meta.setLore(Arrays.asList(ChatColor.WHITE + "Sets the " + ChatColor.GRAY + "Y " + ChatColor.WHITE + "vector",
				ChatColor.WHITE + "component to 0", "",
