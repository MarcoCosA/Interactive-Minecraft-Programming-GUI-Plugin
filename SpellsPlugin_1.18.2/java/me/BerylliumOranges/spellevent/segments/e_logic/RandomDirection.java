...
public class RandomDirection extends EventSegment {
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Random Direction");
		meta.setLore(Arrays.asList(ChatColor.GRAY + "50% " + ChatColor.WHITE + "chance to change the",
				ChatColor.WHITE + "direction " + ChatColor.GRAY + "downwards", "",
