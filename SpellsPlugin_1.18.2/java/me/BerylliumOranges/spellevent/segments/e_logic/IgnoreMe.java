...
public class IgnoreMe extends EventSegment {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		if (proc.getTimesProced()[proc.getY()][proc.getX()] < 2) {
			proc.setDir(proc.getLastDir());
		}
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Ignore First Cast");
		meta.setLore(Arrays.asList(
				ChatColor.WHITE + "This segments " + ChatColor.GRAY + "direction " + ChatColor.WHITE + "is",
				ChatColor.WHITE + "ignored on its " + ChatColor.GRAY + "first " + ChatColor.WHITE + "cast", "",
