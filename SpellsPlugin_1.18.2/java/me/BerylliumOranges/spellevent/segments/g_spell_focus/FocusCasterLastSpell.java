...
public class FocusCasterLastSpell extends EventTriggerSegment {
	...
	public static Guideline processSegment(SegmentProcess proc) {
		...
		proc.setFocusedSpell(EntityStats.getEntityStats(proc.getCaster()).getLastCast());
	...
	public static ItemStack getUpdatedItem(int upgrades[], int dir) {
		...
		meta.setDisplayName(getColorFromRarity(RARITY) + "Focus Caster's Last Spell");
		meta.setLore(Arrays.asList(ChatColor.LIGHT_PURPLE + "Focuses " + ChatColor.WHITE + "the last spell cast",
				ChatColor.WHITE + "by the " + ChatColor.LIGHT_PURPLE + "caster", "",
